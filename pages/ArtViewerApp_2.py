...
class ArtViewerApp(QMainWindow):
    ...
    def setup_ui(self):
        ...
        #self.image_panel.setStyleSheet("border-radius: 15px; border: 2px solid #4a5568;")
        #self.image_panel.setMaximumHeight(600)
        ...
        #self.image_panel.setMinimumSize(250, 450)
        #self.image_panel.setMaximumSize(350, 550)
        #main_layout.addWidget(self.image_panel, alignment=Qt.AlignCenter)

        # Adjusting the aspect ratio for portrait images
        self.image_panel.setMinimumSize(150, 200)
        self.image_panel.setMaximumSize(150, 300)
        ...
        #self.likes_count_label = QLabel("0 Likes")
        #self.likes_count_label.setAlignment(Qt.AlignCenter)
        #self.likes_count_label.setFont(QFont("Inter", 12, QFont.Bold))
        #self.likes_count_label.setStyleSheet("color: #e53e3e;")
        likes_layout.addWidget(self.like_button)

        self.likes_count_label = QVBoxLayout()
        self.likes_count_label = QLabel("0 Likes")
        self.likes_count_label.setAlignment(Qt.AlignCenter)
        self.likes_count_label.setFont(QFont("Inter", 12, QFont.Bold))
        self.likes_count_label.setStyleSheet("color: #e53e3e;")
        likes_layout.addWidget(self.likes_count_label)

        # Ad Button layout
        ad_layout = QVBoxLayout()
        ad_button = self.create_button("Watch an Ad", self.watch_ad, "#F6AD55", "#ED8936")
        ad_layout.addWidget(ad_button)
        ad_layout.addStretch(1)  # Added to align with the likes_count_label
        ...
        exit_layout.addStretch(1)  # Added to align with the likes_count_label'''
        ...
        '''bottom_layout.addLayout(likes_layout)
        ...
        #comments_layout.setAlignment(Qt.AlignCenter)
    ...
    def display_image(self):
        ...
        self.likes_count_label.setText(f"{current_image_data['likes']} Likes")
    ...
    def like_image(self):
        ...
        '''self.likes_count_label.setText(f"{self.art_data[url]['likes']} Likes")'''
